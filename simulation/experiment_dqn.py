...
def train_dqn(env, dqn, num_episodes=100, max_steps_per_episode=400000, verbose=True):
    """
    训练DQN模型
    :param env: 环境实例
    :param dqn: DQN实例
...
def main():
    ...
    # 训练DQN
    print("\n开始训练...")
    train_dqn(env, dqn, num_episodes=2, max_steps_per_episode=400000, verbose=True)
